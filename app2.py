...
app.config ['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:Qwert12345@35.192.144.171/db1'
...
def availability():
    if request.method == 'POST':
        ...
        if not request.form['start_time'] or not request.form['end_time'] or not request.form['importance_name'] or not request.form['year'] or not request.form['month'] or not request.form['date']:
            ...
            cnx = mysql.connector.connect(user="root", password="Qwert12345", host="35.192.144.171", database="db1")
            ...
            cnx2 = mysql.connector.connect(user="root", password="Qwert12345", host="35.192.144.171", database="db1")
            ...
            cnx3 = mysql.connector.connect(user="root", password="Qwert12345", host="35.192.144.171", database="db1")
            ...
            cnx4 = mysql.connector.connect(user="root", password="Qwert12345", host="35.192.144.171", database="db1")
            ...
            cnx5 = mysql.connector.connect(user="root", password="Qwert12345", host="35.192.144.171", database="db1")
            ...
            cnx6 = mysql.connector.connect(user="root", password="Qwert12345", host="35.192.144.171", database="db1")
