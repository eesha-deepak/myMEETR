...
conn.execute('DROP TABLE IF EXISTS time_zone;')
conn.execute('DROP TABLE IF EXISTS meeting_details;')
conn.execute('DROP TABLE IF EXISTS availability_info;')
conn.execute('DROP TABLE IF EXISTS link_meeting;')
conn.execute('DROP TABLE IF EXISTS attendee_info;')
conn.execute('DROP TABLE IF EXISTS importance;')
